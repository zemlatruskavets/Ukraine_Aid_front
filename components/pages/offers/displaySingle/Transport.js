...
export default function ViewTransportOffer({ Offer }) {
  ...
  return (
    <MainGrid>
      ...
      <Content>
        <Title>
          <h1>
            Transportation from {Offer.travelOrigin} to{' '}
            {Offer.travelDestination}
          </h1>
        </Title>
        <Subtitle>
          <p>Leaving at {moment(Offer.time).format('LLL')}</p>
          <p>space for {Offer.numberPeople}</p>
        </Subtitle>
